...
Then from the text file, we create a list of strings from each lines in
the text file.
...
array of strings ("enjoy the excellect band tonight") ["enjoy", "the", "excellent", "band", "tonight"]
